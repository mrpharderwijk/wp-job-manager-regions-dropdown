<?php
/*
 * this file is located in wp-content/plugins/wp-job-manager/wp-job-manager.php
 *
 *
...
class WP_Job_Manager {
	...
	public function frontend_scripts() {
		wp_register_script( 'wp-job-manager-ajax-filters', JOB_MANAGER_PLUGIN_URL . '/assets/js/ajax-filters.js', array( 'jquery' ), JOB_MANAGER_VERSION, true );
